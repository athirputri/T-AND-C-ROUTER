	...
	const onCRAFTTextClick = useCallback(() => {
  	...
  	return (
    		<div className={styles.food}>
      			...
      			<img className={styles.wontonIcon} alt="" src="./images/WONTON.jpg" onClick={onGroupContainerClick} />
<img className={styles.wontonIcon1} alt="" src="./images/WONTON.jpg" onClick={onGroupContainerClick} />
<img className={styles.wontonIcon2} alt="" src="./images/WONTON.jpg" />

<img className={styles.pancakeIcon} alt="" src="./images/PANCAKE.jpg" onClick={onPancakeClick} />
<img className={styles.pancakeIcon1} alt="" src="./images/PANCAKE.jpg" onClick={onPancakeClick} />
<img className={styles.pancakeIcon2} alt="" src="./images/PANCAKE.jpg" onClick={onPancakeClick} />

<img className={styles.tanghuluIcon} alt="" src="./images/TANGHULU.jpg" onClick={onGroupContainerClick} />
<img className={styles.tanghuluIcon1} alt="" src="./images/TANGHULU.jpg" />
<img className={styles.tanghuluIcon2} alt="" src="./images/TANGHULU.jpg" />
      			...
      			<img className={styles.classicScones1} alt="" src="./images/Classic Scones.jpg" />
      			...
      			<img className={styles.kimbabIcon} alt="" src="./images/KIMBAB.jpg" onClick={onGroupContainerClick} />
<img className={styles.kimbabIcon1} alt="" src="./images/KIMBAB.jpg" />
<img className={styles.kimbabIcon2} alt="" src="./images/KIMBAB.jpg" />
<img className={styles.kimbabIcon3} alt="" src="./images/KIMBAB.jpg" />

<img className={styles.chocoTruffleMochi} alt="" src="./images/CHOCO TRUFFLE MOCHI.jpg" onClick={onGroupContainerClick} />
<img className={styles.chocoTruffleMochi1} alt="" src="./images/CHOCO TRUFFLE MOCHI.jpg" />
<img className={styles.chocoTruffleMochi2} alt="" src="./images/CHOCO TRUFFLE MOCHI.jpg" />

<img className={styles.bestSellerIcon} alt="" src="./images/Best Seller.png" />

<img className={styles.starIcon} alt="" src="./images/Star.png" onClick={onGroupContainerClick} />
<img className={styles.starIcon1} alt="" src="./images/Star.png" />
<img className={styles.starIcon2} alt="" src="./images/Star.png" />
<img className={styles.starIcon3} alt="" src="./images/Star.png" onClick={onGroupContainerClick} />
<img className={styles.starIcon4} alt="" src="./images/Star.png" />
<img className={styles.starIcon5} alt="" src="./images/Star.png" onClick={onGroupContainerClick} />
<img className={styles.starIcon6} alt="" src="./images/Star.png" onClick={onGroupContainerClick} />
<img className={styles.starIcon7} alt="" src="./images/Star.png" />
<img className={styles.starIcon8} alt="" src="./images/Star.png" />
<img className={styles.starIcon9} alt="" src="./images/Star.png" />
<img className={styles.starIcon10} alt="" src="./images/Star.png" />
<img className={styles.starIcon11} alt="" src="./images/Star.png" onClick={onGroupContainerClick} />
<img className={styles.starIcon12} alt="" src="./images/Star.png" />
<img className={styles.starIcon13} alt="" src="./images/Star.png" />
<img className={styles.starIcon14} alt="" src="./images/Star.png" />
<img className={styles.starIcon15} alt="" src="./images/Star.png" />
<img className={styles.starIcon16} alt="" src="./images/Star.png" />
<img className={styles.starIcon17} alt="" src="./images/Star.png" />
<img className={styles.starIcon18} alt="" src="./images/Star.png" />
<img className={styles.starIcon19} alt="" src="./images/Star.png" />
<img className={styles.starIcon20} alt="" src="./images/Star.png" onClick={onGroupContainerClick} />
<img className={styles.starIcon21} alt="" src="./images/Star.png" />
<img className={styles.starIcon22} alt="" src="./images/Star.png" />
<img className={styles.starIcon23} alt="" src="./images/Star.png" />
<img className={styles.starIcon24} alt="" src="./images/Star.png" />
<img className={styles.starIcon25} alt="" src="./images/Star.png" />
<img className={styles.starIcon26} alt="" src="./images/Star.png" />
<img className={styles.starIcon27} alt="" src="./images/Star.png" />
<img className={styles.starIcon28} alt="" src="./images/Star.png" />
<img className={styles.starIcon29} alt="" src="./images/Star.png" />
<img className={styles.starIcon30} alt="" src="./images/Star.png" />
<img className={styles.starIcon31} alt="" src="./images/Star.png" />
<img className={styles.starIcon32} alt="" src="./images/Star.png" />
<img className={styles.starIcon33} alt="" src="./images/Star.png" />
<img className={styles.starIcon34} alt="" src="./images/Star.png" />
<img className={styles.starIcon35} alt="" src="./images/Star.png" />
<img className={styles.starIcon36} alt="" src="./images/Star.png" />
<img className={styles.starIcon37} alt="" src="./images/Star.png" />
<img className={styles.starIcon38} alt="" src="./images/Star.png" />
<img className={styles.starIcon39} alt="" src="./images/Star.png" />
<img className={styles.starIcon40} alt="" src="./images/Star.png" />
<img className={styles.starIcon41} alt="" src="./images/Star.png" />
<img className={styles.starIcon42} alt="" src="./images/Star.png" />
<img className={styles.starIcon43} alt="" src="./images/Star.png" />
<img className={styles.starIcon44} alt="" src="./images/Star.png" />
<img className={styles.starIcon45} alt="" src="./images/Star.png" />
<img className={styles.starIcon46} alt="" src="./images/Star.png" />
<img className={styles.starIcon47} alt="" src="./images/Star.png" />
<img className={styles.starIcon48} alt="" src="./images/Star.png" />
<img className={styles.starIcon49} alt="" src="./images/Star.png" />
<img className={styles.starIcon50} alt="" src="./images/Star.png" />
<img className={styles.starIcon51} alt="" src="./images/Star.png" />
<img className={styles.starIcon52} alt="" src="./images/Star.png" />
<img className={styles.starIcon53} alt="" src="./images/Star.png" />
<img className={styles.starIcon54} alt="" src="./images/Star.png" />
      			...
      			<img className={styles.cookiesIcon} alt="" src="./images/COOKIES.jpg" />
      			<img className={styles.cookiesIcon1} alt="" src="./images/COOKIES.jpg" />
      			<img className={styles.dangoIcon} alt="" src="./images/DANGO.jpg" />
      			<img className={styles.dangoIcon1} alt="" src="./images/DANGO.jpg" />
      			<img className={styles.cakeIcon} alt="" src="./images/CAKE.jpg" /> {/* gambar produk  */}
      			<img className={styles.cakeIcon1} alt="" src="./images/CAKE.jpg" />
      			<img className={styles.milleCrepesIcon} alt="" src="./images/MILLE CREPES.jpg" />
      			<img className={styles.milleCrepesIcon1} alt="" src="./images/MILLE CREPES.jpg" />
      			<img className={styles.searchIcon} alt="" src="./images/Search.png" />
      			<img className={styles.fireIcon} alt="" src="./images/Fire.png" />
      			<img className={styles.cakeIcon2} alt="" src="./images/Cake.png" /> {/* cake logo  */}
      			<img className={styles.saladIcon} alt="" src="./images/Salad.png" />
      			<img className={styles.cupcakeIcon} alt="" src="./images/Cupcake.jpg" />
      			<img className={styles.cakeIcon3} alt="" src="./images/Cake.png" />
      			<div className={styles.ellipseDiv} />
      			<img className={styles.bestSellerIcon1} alt="" src="./images/Best Seller.png" onClick={onBestSellerImageClick} />
      			<div className={styles.foodChild59} />
      			<img className={styles.fireIcon1} alt="" src="./images/Fire.png" onClick={onFireImageClick} />
      			<div className={styles.foodChild60} />
      			<img className={styles.cakeIcon4} alt="" src="./images/Cake.png" onClick={onCakeImageClick} />
      			<div className={styles.foodChild61} />
      			<img className={styles.saladIcon1} alt="" src="./images/Salad.png" onClick={onSaladImageClick} />
      			<div className={styles.foodChild62} />
      			<div className={styles.foodChild63} />
      			<img className={styles.coffeeToGo} alt="" src="./images/Coffee to Go.png" onClick={onCoffeeToGoClick} />
      			<img className={styles.coffeeToGo1} alt="" src="./images/Coffee to Go.png" />
      			<img className={styles.soupPlateIcon} alt="" src="./images/Soup Plate.png" onClick={onSoupPlateImageClick} />
      			<img className={styles.soupPlateIcon1} alt="" src="./images/Soup Plate.png" />
      			<img className={styles.corndog1Icon} alt="" src="./images/CORNDOG.jpg" />
      			<img className={styles.milkBun1} alt="" src="./images/Milk Bun.jpg" />
      			<img className={styles.greentea1Icon} alt="" src="./images/greentea.jpg" />
      			<img className={styles.kopiSusuAren1} alt="" src="./images/Kopi Susu Aren.jpg" />
      			<img className={styles.chocoOatLatte} alt="" src="./images/Choco Oat Latte.jpg" />
      			<img className={styles.cappuccinoIcon} alt="" src="./images/Cappuccino.jpg" />
      			<img className={styles.arenLatteIcon} alt="" src="./images/Aren Latte.jpg" />
      			<img className={styles.spanishLatte1} alt="" src="./images/Spanish Latte.jpg" />
      			<img className={styles.americanoIcon} alt="" src="./images/Americano.jpg" />
      			<img className={styles.caffeMochaIcon} alt="" src="./images/Caffe Mocha.jpg" />
      			<img className={styles.breveLatteIcon} alt="" src="./images/Breve Latte.jpg" />
      			<img className={styles.caffeLatte1} alt="" src="./images/Caffe Latte.jpg" />
      			<img className={styles.beefLasagnaIcon} alt="" src="./images/BEEF LASAGNA.jpg" />
      			<img className={styles.cromboloniIcon} alt="" src="./images/CROMBOLONI.jpg" />
      			<img className={styles.mangoOnIcon} alt="" src="./images/Mango On.jpg" />
      			<img className={styles.purpleNana1} alt="" src="./images/Purple Nana.jpg" />
      			<img className={styles.chocoHealthy1} alt="" src="./images/Choco Healthy.jpg" />
      			<img className={styles.odeng1Icon} alt="" src="./images/ODENG.jpg" />
      			<img className={styles.risoles1Icon} alt="" src="./images/RISOLES.jpg" />
      			<img className={styles.mentaiIcon} alt="" src="./images/MENTAI.jpg" />
      			<img className={styles.mieGacoanIcon} alt="" src="./images/mie gacoan.jpg" />
      			<img className={styles.tteokbokki1Icon} alt="" src="./images/Tteokbokki.jpg" />
      			<img className={styles.dimsum1Icon} alt="" src="./images/Dimsum.jpg" />
      			<img className={styles.rujakIcon} alt="" src="./images/Rujak.jpg" />
      			<img className={styles.salmonAvocadoIcon} alt="" src="./images/Salmon Avocado.jpg" />
      			<img className={styles.cucumberSaladIcon} alt="" src="./images/Cucumber Salad.jpg" />
      			<img className={styles.mixFruitSalad1} alt="" src="./images/Mix Fruit Salad.jpg" />
      			<img className={styles.shrimpSaladIcon} alt="" src="./images/Shrimp Salad.jpg" />
      			<img className={styles.ranchChickenSalad1} alt="" src="./images/Ranch Chicken Salad.jpg" />
      			<img className={styles.citrusFennel1} alt="" src="./images/Citrus Fennel.jpg" />
      			<img className={styles.eggSoupIcon} alt="" src="./images/Egg Soup.png" />
