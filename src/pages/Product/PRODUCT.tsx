	...
	const onAddToCartClick = useCallback(() => {
  	...
  	return (
    		<div className={styles.product2}>
      			...
      			<img className={styles.starIcon} alt="" src="./images/Star.png" />
      			...
      			<img className={styles.backArrowIcon} alt="" src="./images/Back Arrow.png" onClick={onFoodTextClick} />
      			...
      			<img className={styles.pancakePict4} alt="" src="./images/Pancake pict 4.jpg" />
      			<img className={styles.pancakePict3} alt="" src="./images/Pancake pict 3.jpg" />
      			<img className={styles.pancakePict2} alt="" src="./images/Pancake pict 2.jpg" />
      			<img className={styles.pancakePict5} alt="" src="./images/Pancake pict 5.jpg" />
    		</div>);
};
